...
def _test_plot_transforms_comparison(
...
def _test_plot_boulder_map(positions_path: str):
...
def _test_plot_boulder_map_comparison(
    positions_path: str, semantic_positions_path: str
):
