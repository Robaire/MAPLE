...
RESULTS_FILE="charging_results.csv"  # File to store results
...
run_simulator() {
    ...
    output=$(timeout $TIMEOUT_PER_RUN uv run ./scripts/run_agent.py agents/charge_bs_tester.py --sim="./simulator" --xy="[$x, $y]" 2>&1)
