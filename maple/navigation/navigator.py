...
class Navigator:
    ...
    def __init__(self, agent):
        ...
        self.global_path.extend(
            generate_flower_petal_spiral(self.lander_x, self.lander_y)
        )
...
def generate_flower_petal_spiral(
    x0, y0, min_radius=4.5, max_spirals=5, points_per_spiral=36, increment=1.4
):
    """
