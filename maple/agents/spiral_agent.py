...
class SpiralAgent(AutonomousAgent):
    ...
    def run_step(self, input_data):
        ...
        ##### Some simple spiral pattern
        if mission_time == int(mission_time): # Only change rotate once each second
            self.current_goal_ang *= .9
        control = carla.VehicleVelocityControl(self.current_goal_vel, self.current_goal_ang)
        ##### Some simple spiral pattern
