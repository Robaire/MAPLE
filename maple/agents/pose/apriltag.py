...
from pose.utils import camera_parameters, carla_to_pytransform

import pose.geometry as geometry
...
class Estimator:
    ...
    def __init__(self, agent):
        ...
        self.initial_rover_global = carla_to_pytransform(agent.get_initial_position())
        lander_rover = carla_to_pytransform(agent.get_initial_lander_position())
        self.lander_global = concat(lander_rover, self.initial_rover_global)
